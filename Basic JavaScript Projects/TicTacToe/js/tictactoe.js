...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            // This function plays dog placement sound.
            audio('./media/placeDog.mp3');
            // Active player may only be 'X' or 'O', so, if not 'X' it must be 'O'
        } else {
            // If activePlsayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/cat.png")';
            //This function plays a cat placement sound.
            audio('./media/placeCat.mp3');
        }
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all inclded in our array then
        //true is returned and our else if condition executes the drawLine() function.
        if (a === true && b === true && c === true) { return true; }
    }
}
//This function makes our body element ootemporarily unclickable.
...
function audio(audioURL) {
    //We create a new audio object and we pass as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives us accesss to methods and properties to use on canvas.
    ...
    let x1 = coordX1,
        ...
        y = y1;
    //This functiion interacts with the canvas.
    function animateLineDrawing() {
        //This variable creates a looop.
        const animationLoop = requestAnimationFrame(animateLineDrawing);
        //This method clears content from the last loop iteration.
        c.clearRect(0,0,608,608);
        //This method starts a new path.
        c.beginPath();
        //This method moves us to a starting poijnt in our line.
        c.moveTo(x1,y1);
